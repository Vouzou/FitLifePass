...
*/
//$available_credits = new PMProRH_Field("credits", "text", array("size"=>5, "memberslistcsv"=>true, "readonly"=>false, "profile"=>true));
//pmprorh_add_registration_field("just_profile", $available_credits);
/*
