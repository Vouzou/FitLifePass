...
function pmpro_shortcode_account($atts, $content=null, $code="")
{
	...
	if(pmpro_hasMembershipLevel())
	{
		...
		$available_credits = pmpro_getAvailableCreditsForUser();
				...
				<table width="100%" cellpadding="0" cellspacing="0" border="0">
					<thead>
						<tr>
							...
							<th><?php _e("Level Credits", 'paid-memberships-pro' ); ?></th>
							<th><?php _e("Available Credits", 'paid-memberships-pro' ); ?></th>
						</tr>
					</thead>
					<tbody>
						<?php
...
-->
							<td class="pmpro_account-membership-credits">
							<?php echo $level->credits ?>
							</td>
							<td class="pmpro_account-membership-available-credits">
